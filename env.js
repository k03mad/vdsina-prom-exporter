...
const env = {
    server: {
        port: process.env.npm_config_port || process.env.VDSINA_EXPORTER_PORT || 11_015,
    },
    vdsina: {
        token: process.env[TOKEN_ENV_NAME] || process.env[`npm_config_${TOKEN_NPM_PARAM_NAME}`],
    },
    metrics: {
        turnOff: process.env.npm_config_turnoff || process.env.VDSINA_EXPORTER_METRICS_TURN_OFF,
    },
